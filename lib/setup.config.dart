...
import 'core/cubits/cached/home_events_cubit/home_events_cubit.dart' as _i13;
...
import 'features/home/data/repositories/events_impl.dart' as _i46;
...
import 'features/home/data/sources/events_network.dart' as _i43;
import 'features/home/data/sources/events_source.dart' as _i42;
import 'features/home/domain/repositories/banners_repository.dart' as _i25;
import 'features/home/domain/repositories/events_repository.dart' as _i45;
import 'features/home/domain/usecases/banners_usecase.dart' as _i27;
import 'features/home/domain/usecases/events_usecase.dart' as _i47;
import 'features/home/presentation/cubits/banners_cubit.dart' as _i38;
import 'features/home/presentation/cubits/events/events_cubit.dart' as _i49;
import 'features/settings/data/repositories/settings_impl.dart' as _i36;
...
import 'features/settings/domain/repositories/settings_repository.dart' as _i35;
import 'features/settings/domain/usecases/settings_usecase.dart' as _i37;
...
_i1.GetIt $initGetIt(
  ...
  gh.factoryParam<_i13.HomeEventsCubit, String, dynamic>((
    key,
    _,
  ) =>
      _i13.HomeEventsCubit(key));
  ...
  gh.lazySingleton<_i35.SettingsRepository>(
      () => _i36.SettingsRepositoryImpl(get<_i17.SettingsSource>()));
  gh.lazySingleton<_i37.SettingsUsecase>(
      () => _i37.SettingsUsecase(get<_i35.SettingsRepository>()));
  gh.lazySingleton<_i38.BannersCubit>(() => _i38.BannersCubit(
        get<_i27.BannersUseCase>(),
        get<_i7.CachedBannersCubit>(),
      ));
  gh.lazySingleton<_i39.CommentSectionRepository>(() =>
      _i40.CommentSectionRepositoryImpl(get<_i28.CommentSectionSource>()));
  gh.lazySingleton<_i41.CommentSectionUsecase>(
      () => _i41.CommentSectionUsecase(get<_i39.CommentSectionRepository>()));
  gh.lazySingleton<_i42.EventsSource>(
      () => _i43.EventsNetwork(get<_i34.MainApi>()));
  ...
  gh.lazySingleton<_i45.EventsRepository>(
      () => _i46.EventsRepositoryImpl(get<_i42.EventsSource>()));
  gh.lazySingleton<_i47.EventsUseCase>(
      () => _i47.EventsUseCase(get<_i45.EventsRepository>()));
  gh.lazySingleton<_i48.SendCommentCubit>(() => _i48.SendCommentCubit(
        get<_i19.TokenProvider>(instanceName: 'CommentsTokenImpl'),
        get<_i22.UserCubit>(),
        get<_i41.CommentSectionUsecase>(),
        get<_i8.DeviceInfoProvider>(),
        get<_i44.CommentSectionCubit>(),
      ));
  gh.lazySingleton<_i49.EventsCubit>(
      () => _i49.EventsCubit(get<_i47.EventsUseCase>()));
  return get;
}
